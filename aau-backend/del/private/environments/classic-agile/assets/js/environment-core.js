...
function initializeRuntimeSession() {
    ...
    window.LAAUDelStorage.session.setItem(
        environmentPersistenceKeys
            .runtimeSession,
        "true"
    );
...
function logEnvironmentRuntimeState() {
    ...
    console.log(
        ...
        window.LAAUDelStorage.local.getItem(
            environmentPersistenceKeys
                .completionState
        )
    );
...
function resetEnvironmentProgression() {
    ...
    window.LAAUDelStorage.local.removeItem(
        environmentPersistenceKeys
            .completionState
    );
    ...
    window.LAAUDelStorage.session.removeItem(
        environmentPersistenceKeys
            .runtimeSession
    );
